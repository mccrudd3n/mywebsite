---
title: "Molecular Biology & Genomic"
date: 2020-04-26
draft: false
...
skills:
  ...
  - Genomic Data Structures (FASTA, VCF, BAM)
  - Bioinformatics Pipelines (BWA, GATK, SAMtools)
  - Biostatistics & Hypothesis Testing
  - R & Python for Genomic Analysis
  - Unix/Linux Command Line
  - GWAS & Selective Breeding Modelling
  - Data Quality & Reproducibility in Biotech
cover:
...
- **Category: Unix/Linux** – `awk`, `grep`, `bash` pipelines on HPC clusters  
- **Category: Biostatistics** – FDR correction, logistic regression on GWAS hits  
